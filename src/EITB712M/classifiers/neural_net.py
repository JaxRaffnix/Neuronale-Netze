...
class TwoLayerNet(object):
    ...
    We train the network with a MSVM loss function and L2 regularization on the
    weight matrices. The network uses a ReLU nonlinearity after the first fully
    connected layer.

    In other words, the network has the following architecture:

    input - fully connected layer - ReLU - fully connected layer - MSVM
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        # in the variable loss, which should be a scalar. Use the MSVM              #
        # classifier loss. Hint: You can copy paste your solution from the MSVM     #
        # excercise.                                                                #
        #############################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
