...
Ziel ist, mit verschiedenen Methoden den [CIFAR10](https://www.cs.toronto.edu/~kriz/cifar.html) Datensatz mit Python zu klassifizieren. Darüber hinaus wird der knn Algorithmus, Multiclass Support Vector Machines, Transfer Learning, semantische Segmentierung und Style Transfer behandelt. AUch der [Kaggle dogs-vs-cats](https://www.kaggle.com/competitions/dogs-vs-cats) wird betrachtet.
...
![Predictions](<talk/images/predictions_grid.png>)
![Matrix](<talk/images/confusion_matrix.png>)
![accuracy](talk/images/all_trials_accuracy.png)
